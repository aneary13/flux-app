...
function SetRow({ exercise, setIndex, isConditioning }: SetRowProps) {
  ...
  const [metricValue, setMetricValue] = useState(
    currentLog.reps?.toString() || currentLog.seconds?.toString() || ''
  );
  ...
  if (!isEditing) {
    return (
      ...
      >
        <Typography variant="label" style={styles.setNumber}>
          Set {setIndex + 1}
        </Typography>
  ...
  if (isConditioning) {
    ...
    return (
      <View style={styles.activeRowContainer}>
        ...
        >
          <Typography variant="label" style={styles.activeSetHeader}>
            Round {setIndex + 1}
          </Typography>
          ...
          <View style={{ alignItems: 'flex-end' }}>
            ...
            {targetText && (
              <Typography
                variant="caption"
                style={{ marginTop: 2, fontWeight: 'bold', color: theme.colors.textPrimary }}
              >
                {targetText}
              </Typography>
            )}
        ...
        <View style={[styles.inputRow, styles.bottomInputRow]}>
          <View style={styles.inputGroup}>
            <TextInput
              style={[styles.input, { minWidth: 45 }]}
              keyboardType="numeric"
              placeholder="Avg"
              placeholderTextColor={theme.colors.borderLight}
              value={avgHr}
  ...
  return (
    <View style={styles.activeRowContainer}>
      ...
      <View style={styles.inputRow}>
        <View style={styles.inputGroup}>
          {isBodyweight && (
            <Typography variant="caption" style={styles.prefix}>
              BW +
            </Typography>
          )}
          <TextInput
      ...
      <View style={[styles.inputRow, styles.bottomInputRow]}>
        ...
        >
          <Ionicons
            ...
            size={20}
            color={isWarmup ? theme.colors.stateOrange : theme.colors.textMuted}
          />
    ...
    <View style={styles.cardContainer}>
      ...
      {!isConditioning && (
        ...
        >
          ...
          <Typography variant="label" style={{ marginLeft: 4 }}>
            Add Set
          </Typography>
        </TouchableOpacity>
      )}
